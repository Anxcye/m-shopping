<template>
  <div class="category">
    ...
    <div class="list-box">
      ...
      <div class="right">
        <div @click="$router.push(`/searchlist?categoryId=${item.category_id}`)" v-for="item in getChildren(list[activeIndex])" :key="item.category_id" class="cate-goods">
...
export default {
  ...
  methods: {
    ...
    getImageUrl (item) {
      return item && item.image && item.image.external_url ? item.image.external_url : ''
    }
  }
}
</script>
